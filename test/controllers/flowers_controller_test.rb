...
class FlowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flower" do
    assert_difference('Flower.count') do
      post flowers_url, params: { flower: { description: @flower.description, indica_id: @flower.indica_id, name: @flower.name, price: @flower.price, sativa_id: @flower.sativa_id, thc: @flower.thc } }
    end
  ...
  test "should update flower" do
    patch flower_url(@flower), params: { flower: { description: @flower.description, indica_id: @flower.indica_id, name: @flower.name, price: @flower.price, sativa_id: @flower.sativa_id, thc: @flower.thc } }
